 ...
 */
type CAMPAIGN_IMPL struct {
     config configuration_pkg.CONFIGURATION
}

/**
 * Get Campaign Message Status
 * @param    int64        campaignId     parameter: Required
 * @return	Returns the interface{} response from the API call
 */
func (me *CAMPAIGN_IMPL) GetCampaignMessageStatus (
            campaignId int64) (interface{}, error) {
    //the endpoint path uri
    _pathUrl := "/Campaign/Statistics"
