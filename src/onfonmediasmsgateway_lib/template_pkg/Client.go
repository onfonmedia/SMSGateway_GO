...
/**
 * Create New Template
 * @param    string        messageTemplate     parameter: Required
 * @param    string        templateName        parameter: Required
 * @return	Returns the interface{} response from the API call
 */
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *TEMPLATE_IMPL) DeleteTemplate (
            id int64) (interface{}, error) {
    //the endpoint path uri
    _pathUrl := "/Template"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //prepare API request
    _request := unirest.Delete(_queryBuilder, headers, parameters)
    //and invoke the API call request to fetch the response
    _response, err := unirest.AsString(_request,false);
    if err != nil {
        //error in API invocation
