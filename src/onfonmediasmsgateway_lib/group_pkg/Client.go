...
/**
 * Create New Group
 * @param    string        groupName     parameter: Required
 * @return	Returns the interface{} response from the API call
 */
func (me *GROUP_IMPL) CreateNewGroup (
            groupName string) (interface{}, error) {
    //the endpoint path uri
    _pathUrl := "/Group"
...
func (me *GROUP_IMPL) UpdateGroup (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //prepare API request
    _request := unirest.Put(_queryBuilder, headers, parameters)
    //and invoke the API call request to fetch the response
    _response, err := unirest.AsString(_request,false);
    if err != nil {
        //error in API invocation
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *GROUP_IMPL) DeleteGroup (
